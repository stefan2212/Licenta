...
\begin{theorem}
Fie $N=P^{b-1}Q$ să fie modulul RSA, pentru $b \geqslant 3$. Fie $e= N^{\alpha} \leqslant N^{(b-1)/b^2}$ un exponent public valid pentru schema lui Takagi, iar $d_P$ și $d_Q$ să fie exponenții CRT ce satisfac condiția $ed \equiv 1 \ mod \ (P-1)$ și $ed \equiv 1 \ mod \ (Q-1)$. Dat $d_P \textprime$ astfel încât 
$$  \left| d_P - d_P \textprime \right| \leqslant N^{\frac{b-1}{b^2}- \alpha}  $$ 
sau $d_Q \textprime$ astfel încât 
$$ \left| d_Q - d_Q \textprime \right| \leqslant N^{\frac{1}{b^2}- \alpha} $$
...
\item $d_P \textprime$ astfel încât $ \left| d_P - d_P \textprime \right| \leqslant N^{(b-1)/b^2}$
\item $M_Q \geqslant N^{(b-1)/b^2}$ și $d_Q \textprime \equiv d_P \ mod \ M_Q$
\item $d_Q \textprime$ astfel încât $ \left| d_Q - d_Q \textprime \right| \leqslant N^{1/b^2}$
\end{enumerate}
